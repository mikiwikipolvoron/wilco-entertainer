...
COPY --from=install /temp/dev/apps/entertainer/node_modules node_modules
COPY ./apps/entertainer/ .
...
COPY --from=install /temp/prod/apps/entertainer/node_modules node_modules
